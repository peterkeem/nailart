...
export default function AetherHero({
  ...
  return (
    ...
    >
      ...
      {/* Content layer */}
      <div
        className={`aurora-content relative z-10 h-full flex items-center ${justifyClass}`}
        style={{
      ...
      >
        ...
        >
          ...
          {subtitle ? (
            <p
              className="mt-4 opacity-90 max-w-[900px]"
              style={{
          ...
          {(ctaLabel || secondaryCtaLabel) && (
            <div className="inline-flex gap-3 mt-8 flex-wrap">
              {ctaLabel ? (
                <a
                  href={ctaHref}
                  className="aurora-btn aurora-btn--primary px-5 py-3 rounded-xl bg-gradient-to-b from-white/18 to-white/6 no-underline font-semibold shadow-[inset_0_0_0_1px_rgba(255,255,255,.28),0_10px_30px_rgba(0,0,0,.2)] backdrop-blur-md backdrop-saturate-[120%]"
              ...
              {secondaryCtaLabel ? (
                <a
                  ...
                  className="aurora-btn aurora-btn--ghost px-5 py-3 rounded-xl bg-transparent opacity-85 no-underline font-semibold shadow-[inset_0_0_0_1px_rgba(255,255,255,.28)] backdrop-blur-sm"
                  style={{ color: textColor }}
                >
                  {secondaryCtaLabel}
                </a>
